...
BENCHMARK_CASES: tuple[EditorialFormatBenchmarkCase, ...] = (
    EditorialFormatBenchmarkCase(
        ...
        body=(
            "وجه المرور السعودي تنبيهًا إلى مخاطر المراوغة بين المركبات أثناء "
            "السير بسرعة، موضحًا أن مرتكب المخالفة يواجه غرامة تبدأ من 3,000 "
            "ريال سعودي وتصل إلى 6,000 ريال سعودي. وتشمل المخاطر فقدان السيطرة "
            "على المركبة ووقوع تصادمات وتعريض مستخدمي الطريق للخطر، مع التأكيد "
            "على الالتزام بالمسار وضبط السرعة وترك مسافة أمان."
        ),
